...
bool Check4Keystroke(void)
{
  if (IsNewKeyReady())   // new key waiting?
  {
    ...
    switch(ThisEvent.EventParam)
    {
      ...
      break;
      case 'w':
        ThisEvent.EventType = End_Of_Game;
        ThisEvent.EventParam = WIN;
        ES_PostAll(ThisEvent);
      break;
      ...
      case 'c':
     ThisEvent.EventType  = Interaction_Completed;
      PostArcadeFSM(ThisEvent);
      break;
