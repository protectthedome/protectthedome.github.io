...
#define SERV_0_INIT InitButtonDebounce
// the name of the run function
#define SERV_0_RUN RunButtonDebounce
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "ArcadeFSM.h"
// the name of the Init function
#define SERV_1_INIT InitArcadeFSM
// the name of the run function
#define SERV_1_RUN RunArcadeFSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "GlobalTimer.h"
// the name of the Init function
#define SERV_2_INIT InitGlobalTimer
// the name of the run function
#define SERV_2_RUN RunGlobalTimer
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "ResetService.h"
// the name of the Init function
#define SERV_3_INIT InitResetService
// the name of the run function
#define SERV_3_RUN RunResetService
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public function prototypes
#define SERV_4_HEADER "PowerCrank_SM.h"
// the name of the Init function
#define SERV_4_INIT InitPowerCrank_SM
// the name of the run function
#define SERV_4_RUN RunPowerCrank_SM
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public function prototypes
#define SERV_5_HEADER  "Meteor_SM.h"
// the name of the Init function
#define SERV_5_INIT  InitMeteor_SM
// the name of the run function
#define SERV_5_RUN  RunMeteor_SM
// How big should this services Queue be?
...
#if NUM_SERVICES > 6
// the header file with the public function prototypes
#define SERV_6_HEADER "Cannon_SM.h"
// the name of the Init function
#define SERV_6_INIT InitCannon_SM
// the name of the run function
#define SERV_6_RUN RunCannon_SM
// How big should this services Queue be?
...
#if NUM_SERVICES > 7
// the header file with the public function prototypes
#define SERV_7_HEADER "WelcomeFSM.h"
// the name of the Init function
#define SERV_7_INIT InitWelcomeFSM
// the name of the run function
#define SERV_7_RUN RunWelcomeFSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 8
// the header file with the public function prototypes
#define SERV_8_HEADER "EndGameFSM.h"
// the name of the Init function
#define SERV_8_INIT InitEndGameFSM
// the name of the run function
#define SERV_8_RUN RunEndGameFSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 9
// the header file with the public function prototypes
#define SERV_9_HEADER "AirLeak_SM.h"
// the name of the Init function
#define SERV_9_INIT InitAirLeak_SM
// the name of the run function
#define SERV_9_RUN RunAirLeak_SM
// How big should this services Queue be?
...
#define EVENT_CHECK_LIST CheckButtonEvents, PotChecker, TotChecker, CheckPowerCrankEvents, AirPlugChecker, Check4Keystroke
//#define EVENT_CHECK_LIST Check4Keystroke, PotChecker
...
#define TIMER0_RESP_FUNC PostGlobalTimer
#define TIMER1_RESP_FUNC PostButtonDebounce
#define TIMER2_RESP_FUNC PostArcadeFSM
#define TIMER3_RESP_FUNC PostArcadeFSM
#define TIMER4_RESP_FUNC PostResetService
#define TIMER5_RESP_FUNC PostWelcomeFSM
#define TIMER6_RESP_FUNC PostAirLeak_SM
#define TIMER7_RESP_FUNC PostMeteor_SM
#define TIMER8_RESP_FUNC PostCannon_SM
#define TIMER9_RESP_FUNC PostPowerCrank_SM
#define TIMER10_RESP_FUNC PostEndGameFSM
...
#define GLOBAL_TIMER 0
#define DEBOUNCE_TIMER 1
#define BUZZER_TIMER 2
#define INTERACTION_TIMER 3
#define RESET_TIMER 4
#define WELCOME_TIMER 5
#define AIRLEAK_TIMER 6
#define METEOR_TIMER 7
#define CANNON_TIMER 8
#define CRANK_TIMER 9
#define ENDOFGAME_TIMER 10
